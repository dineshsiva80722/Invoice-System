...
//     console.log('handleDeleteInvoice called with invoiceId:', invoiceId);
...
//           console.log(`Updated invoices list, now has ${updatedInvoices.length} invoices`);
//           return updatedInvoices;
//         });
//         alert('Invoice deleted successfully');
//       } else {
//         throw new Error('The server failed to delete the invoice. Please try again.');
//       }
//     } catch (error) {
...
//                           console.log('Invoice ID from object:', invoice.id);
...
//               if (!invoiceId) {
//                 console.warn(
//                   "Cannot update invoice status: No invoice ID found"
//                 );
//                 alert(
//                   "Email prepared, but could not update invoice status: Missing invoice ID"
//                 );
//                 return;
//               }
...
//                 await databaseService.updateInvoice(String(invoiceId), {
//                   status: "sent",
//                 });
...
//                 const errorMessage = updateError.message || 'Failed to update invoice status';
//                 alert(`Error: ${errorMessage}`);
//                 console.error("Error updating invoice status:", updateError);
//                 // Show error to user
//                 alert(
//                   "Email prepared, but failed to update invoice status. Please refresh the page to see the latest status."
//                 );
//               }
//             } catch (error) {
